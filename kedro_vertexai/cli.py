...
@click.option(
    ...
    type=str,
    default=None,
    help="Description of the resulting KFP template.",
)
@click.pass_context
def compile(ctx, image, pipeline, output, params, name, desc) -> None:
    """Translates Kedro pipeline into JSON/YAML Vertex AI Pipelines representation."""
